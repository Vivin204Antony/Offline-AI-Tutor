...
interface UiState {
    ...
    /** Removes the last loading message (isLoading == true) from the list. */
...
class GenericUiState(
    ...
    override fun removeLoadingMessage() {
        val idx = _messages.indexOfLast { it.isLoading }
...
class DeepSeekUiState(
    ...
    private var START_TOKEN = ""
    private var PROMPT_PREFIX = ""
